...
expect('use prefered profile', '[{"eduPersonPrimaryAffiliation":"staff","uid":"fbar"}]', 'searchUser', ['token' => 'fbar', 'attrs' => 'eduPersonPrimaryAffiliation']);
expect('use prefered profile', '[{"eduPersonPrimaryAffiliation":"teacher","uid":"fbar"}]', 'searchUser', ['token' => 'fbar', 'profile_supannEntiteAffectation' => 'DS', 'attrs' => 'eduPersonPrimaryAffiliation']);
test_js_attr('use prefered profile', 'searchUser', 'employeeType', ['token' => 'fbar'], 'null');
