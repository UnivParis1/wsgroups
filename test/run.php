...
expect_json('use prefered profile', 'searchUser', ['token' => 'fbar', 'attrs' => 'eduPersonPrimaryAffiliation'], '[{"eduPersonPrimaryAffiliation":"staff","uid":"fbar"}]');
