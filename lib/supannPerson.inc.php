...
function GET_extra_people_filter_from_params() {
  $filters = array();
  $filters_not = array();
  foreach (array("eduPersonAffiliation", "eduPersonPrimaryAffiliation", "supannEntiteAffectation", "description", "employeeType", "supannActivite", "supannRoleGenerique", "uid") as $attr) {
